...
the program, add a new fact to the
database, or quit the program. 
...
Don't use single capital letters for 
individual names!
Spaces other than blank lines will 
break the program.
...
class Dapylog:
    ...
    def menuSwitch(self,option):
        ...
        elif option == 9: self.saveNewFile()
        elif option == 10: quit()
        else: print("\nInvalid Input\nTry Again\n\n"); self.showMenu()
